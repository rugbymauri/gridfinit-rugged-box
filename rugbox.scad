...
InnerBoxDepth = ysize*gridfinity_pitch+(tolerance*2);
InnerBoxWidth = xsize*gridfinity_pitch+(tolerance*2);
InnerCornerRadius=4;

InnerBoxBottomHeight = gridfinity_zpitch*zsize_bottom+3.75;
InnerBoxLidHeight = gridfinity_zpitch*zsize_lid+3.75;
